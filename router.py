...
class PortfolioNetwork2410(Topo):
    ...
    def build(self, **_opts):
        ...
        self.addLink(r1, r2, intfName1='r1-eth1', params1={'ip': '10.0.1.1/24'}, bw=40, delay='10ms', max_queue_size=67,
                     use_htb=True)  # ,max_queue_size=834, use_htb=True)
        ...
        self.addLink(r2, r3, intfName1='r2-eth2', params1={'ip': '10.0.3.1/24'}, bw=30, delay='20ms',
                     max_queue_size=100, use_htb=True)  # ,max_queue_size=834, use_htb=True)
        ...
        self.addLink(r3, r4, intfName1='r3-eth3', params1={'ip': '10.0.6.1/24'}, bw=20, delay='10ms', max_queue_size=33,
                     use_htb=True)  # ,max_queue_size=834, use_htb=True)
